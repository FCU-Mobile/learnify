-- Fall Semester Leaderboard Function with Quiz + Project Ratings
-- Migration: 20250920_add_fall_leaderboard_function.sql

-- Create Fall semester specific function for quiz points + project ratings
...
BEGIN
    ...
    -- Return ranked students with their scores
    RETURN QUERY
...
-- Index will be created after project_ratings table is available